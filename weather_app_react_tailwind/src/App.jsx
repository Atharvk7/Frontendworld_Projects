    ...
    <div className="bg-gray-800 h-screen grid place-items-center">
      <div className=" w-96 p-4 rounded-md">
        ...
        <div className="flex items-center justify-between" >
          ...
          p-2 border-gray-200 font-semibold uppercase flex-1 rounded-l-lg"

          
          />
          <button onClick={fetchWeather} type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-r-lg text-sm px-4 py-3.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
